...
@author: maitri
"""
#---------------------------------MAIN CODE AND SOME DATA COLLECTION (FIRST PART)----------------------------------------------
...
def H_full_basis(L):
    ...
    return H
'''
eg_val_full_Hilbert_space = np.linalg.eigh( H_full_basis(L))[0] # Diagonalizing the full Hamiltonian directly # uncommand this while the direct diagonalization is needed only'''
...
#np.savetxt("/home/maitri/Documents/Official/Courses/Com putational Course/Project/suzuki_trotter_t_list_A_B_expc_L14",stacked_ST_t_list_A_B_expc,delimiter='t', header = "t_list \t\t\t ST_A_expc \t\t\t ST_B_expc")
...
#np.savetxt("/home/maitri/comp_phy/t50_At_Bt_1000steps_L8",data_t_At_Bt,delimiter='\t')
...
#np.savetxt("/home/maitri/Documents/Official/Courses/Com putational Course/Project/eigenvalues_by_diagonalizing_the_blocks_L10",x1, delimiter='\t')
#np.savetxt("/home/maitri/Documents/Official/Courses/Com putational Course/Project/eigenvalues_by_diagonalizing_the_full_hilbert_space_directly_L10",x1_prime, delimiter='\t')
...
#np.savetxt("E:\Com putational Course\Project\project_data/energ_by_L14_A_B",data_energ_by_L_A_B,delimiter='\t')
#np.savetxt('/home/maitri/comp_phy/energ_by_L_A_B_for_L8.txt',data_energ_by_L_A_B,delimiter='\t',header='E_by_L\t\t\t\t\tA\t\t\t\tB')  
...
#np.savetxt("/home/maitri/comp_phy/data_E_by_L_of_MSS_Ent_entropy_L8",data_E_by_L_Ent_entropy,delimiter='\t')
...
#np.savetxt("/home/maitri/comp_phy/ent_entropy_sub_size_E0_Eptminus2_L8",data_sub_size_E0_Eptminus2,delimiter='\t')
...
#np.savetxt("/home/maitri/comp_phy/ent_entropy_time_evolution_L8",np.array(ent_entropy_time_evolution),delimiter='\t')

'''



# ---------------------------- Making the plots from the stored data (THIRD PART)-------------------------------------------------


#------------------------- Energy Inverse Temperature relation---------------
'''
data_EbyL_ent8 = np.loadtxt("data_E_by_L_of_MSS_Ent_entropy_L8",dtype = np.complex128)
data_EbyL_ent10 = np.loadtxt("data_E_by_L_of_MSS_Ent_entropy_L10",dtype = np.complex128)
data_EbyL_ent12 = np.loadtxt("data_E_by_L_of_MSS_Ent_entropy_L12",dtype = np.complex128)
data_EbyL_ent14 = np.loadtxt("data_E_by_L_of_MSS_Ent_entropy_L14",dtype = np.complex128)
data_EbyL_ent16 = np.loadtxt("data_E_by_L_of_MSS_Ent_entropy_L16",dtype = np.complex128)


data_EbyL8 = np.transpose(data_EbyL_ent8 )
data_EbyL10 = np.transpose(data_EbyL_ent10)
data_EbyL12 = np.transpose(data_EbyL_ent12 )
data_EbyL14 = np.transpose(data_EbyL_ent14 )
data_EbyL16 = np.transpose(data_EbyL_ent16 )


E8 = 8*data_EbyL8 [0]
E10 = 10*data_EbyL10 [0]
E12 = 12*data_EbyL12[0]
E14 = 14*data_EbyL14[0]
E16 = 16*data_EbyL16 [0]
...
E8_byL_av_list = [(1/8)*E_av(beta,E8) for beta in beta_list]
E10_byL_av_list = [(1/10)*E_av(beta,E10) for beta in beta_list]
E12_byL_av_list = [(1/12)*E_av(beta,E12) for beta in beta_list]
E14_byL_av_list = [(1/14)*E_av(beta,E14) for beta in beta_list]
E16_byL_av_list = [(1/16)*E_av(beta,E16) for beta in beta_list]

plt.figure()
plt.plot(E8_byL_av_list ,beta_list,label ="$L = 8$",linestyle ="-.")
plt.plot(E10_byL_av_list ,beta_list,label ="$L = 10$",linestyle ="-.")
plt.plot(E12_byL_av_list ,beta_list,label ="$L = 12$",linestyle ="-.")
plt.plot(E14_byL_av_list ,beta_list,label ="$L = 14$",linestyle ="-.")
plt.plot(E16_byL_av_list ,beta_list,label ="$L = 16$",linestyle ="-.")
plt.legend()
plt.xlabel("E/L")
plt.ylabel(r"$\beta$")
plt.show()

#----------------------------- Energy eigenstate expectation value, operator A and B as a function of energy eigenvalue


energ_by_L_A_B_L8 = np.transpose( np.loadtxt("energ_by_L_A_B_for_L8.txt", dtype = np.complex128))
energ_by_L_A_B_L10 = np.transpose(np.loadtxt("energ_by_L_A_B_for_L10.txt", dtype = np.complex128))
energ_by_L_A_B_L12 = np.transpose(np.loadtxt("energ_by_L_A_B_for_L12.txt", dtype = np.complex128))
energ_by_L_A_B_L14 = np.transpose(np.loadtxt("energ_by_L_A_B_for_L14.txt", dtype = np.complex128))
energ_by_L_A_B_L16 = np.transpose(np.loadtxt("energ_by_L_A_B_for_L16.txt", dtype = np.complex128))

E_by_L8 = energ_by_L_A_B_L8[0]
E_by_L10 = energ_by_L_A_B_L10[0]
E_by_L12 = energ_by_L_A_B_L12[0]
E_by_L14 = energ_by_L_A_B_L14[0]
E_by_L16 = energ_by_L_A_B_L16[0]


A_expec8 = energ_by_L_A_B_L8[1]
A_expec10 = energ_by_L_A_B_L10[1]
A_expec12 = energ_by_L_A_B_L12[1]
A_expec14 = energ_by_L_A_B_L14[1]
A_expec16= energ_by_L_A_B_L16[1]

B_expec8 = energ_by_L_A_B_L8[2]
B_expec10 = energ_by_L_A_B_L10[2]
B_expec12 = energ_by_L_A_B_L12[2]
B_expec14 = energ_by_L_A_B_L14[2]
B_expec16= energ_by_L_A_B_L16[2]

plt.figure()
plt.scatter(E_by_L8 , A_expec8, label = "$L = 8$", marker = 'o')
plt.scatter(E_by_L10 , A_expec10, label = "$L = 10$", marker = '.')
plt.scatter(E_by_L12 , A_expec12, label = "$L = 12$", marker = ',')
plt.scatter(E_by_L14 , A_expec14, label = "$L = 14$", marker = 'v')
plt.scatter(E_by_L16 , A_expec16, label = "$L = 16$", marker = '^')
plt.legend()
plt.xlabel("E/L")
plt.ylabel("expectation value of A")
plt.show()


plt.figure()
plt.scatter(E_by_L8 , B_expec8, label = "$L = 8$", marker = 'o')
plt.scatter(E_by_L10 , B_expec10, label = "$L = 10$", marker = '.')
plt.scatter(E_by_L12 , B_expec12, label = "$L = 12$", marker = ',')
plt.scatter(E_by_L14 , B_expec14, label = "$L = 14$", marker = 'v')
plt.scatter(E_by_L16 , B_expec16, label = "$L = 16$", marker = '^')
plt.legend()
plt.xlabel("E/L")
plt.ylabel("expectation value of B")
plt.show()


#------------------------- Time dependent expectation value of A and B------------------------

t50_At_Bt_1000steps_L8 = np.transpose(np.loadtxt("t50_At_Bt_1000steps_L8.txt",dtype = np.complex128))
t50_At_Bt_1000steps_L10 = np.transpose(np.loadtxt("t50_At_Bt_1000steps_L10.txt",dtype = np.complex128))
t50_At_Bt_1000steps_L12 = np.transpose(np.loadtxt("t50_At_Bt_1000steps_L12.txt",dtype = np.complex128))
t50_At_Bt_1000steps_L14 = np.transpose(np.loadtxt("t50_At_Bt_1000steps_L14.txt",dtype = np.complex128))
t50_At_Bt_1000steps_L16 = np.transpose(np.loadtxt("t50_At_Bt_1000steps_L16.txt",dtype = np.complex128))

t50_1000steps8 = t50_At_Bt_1000steps_L8 [0]
t50_1000steps10 = t50_At_Bt_1000steps_L10 [0]
t50_1000steps12 = t50_At_Bt_1000steps_L12 [0]
t50_1000steps14 = t50_At_Bt_1000steps_L14 [0]
t50_1000steps16 = t50_At_Bt_1000steps_L16 [0]


At_list8 = t50_At_Bt_1000steps_L8[1]
At_list10 = t50_At_Bt_1000steps_L10[1]
At_list12 = t50_At_Bt_1000steps_L12[1]
At_list14 = t50_At_Bt_1000steps_L14[1]
At_list16 = t50_At_Bt_1000steps_L16[1]

Bt_list8 = t50_At_Bt_1000steps_L8[2]
Bt_list10 = t50_At_Bt_1000steps_L10[2]
Bt_list12 = t50_At_Bt_1000steps_L12[2]
Bt_list14 = t50_At_Bt_1000steps_L14[2]
Bt_list16 = t50_At_Bt_1000steps_L16[2]


plt.figure()
plt.plot(t50_1000steps8,At_list8,label="$L = 8$", linestyle = '--')
plt.plot(t50_1000steps10,At_list8,label="$L = 10$", linestyle = "-.")
plt.plot(t50_1000steps12,At_list12,label="$L = 12$", linestyle =":")
plt.plot(t50_1000steps14,At_list14,label="$L = 14$", linestyle = '-')
plt.plot(t50_1000steps16,At_list16,label="$L = 16$", marker = '.')

plt.xlabel("time")
plt.ylabel('time dependent expectation value of A')
plt.legend()
plt.show()

plt.figure()
plt.plot(t50_1000steps8,Bt_list8,label="$L = 8$", linestyle = '--')
plt.plot(t50_1000steps10,Bt_list8,label="$L = 10$", linestyle = "-.")
plt.plot(t50_1000steps12,Bt_list12,label="$L = 12$", linestyle =":")
plt.plot(t50_1000steps14,Bt_list14,label="$L = 14$", linestyle = '-')
plt.plot(t50_1000steps16,Bt_list16,label="$L = 16$", marker = '.')

plt.xlabel("time")
plt.ylabel('time dependent expectation value of B')
plt.legend()
plt.show()



#-----------------expectation value of time evolved A and B operator using suzuki trotter---------------

st_data = np.loadtxt("suzuki_trotter_t_list_A_B_expc_L14.txt",dtype = np.complex128)
st_t_list = st_data[:,0]
st_A_expc = st_data[:,1]
st_B_expc = st_data[:,2]

plt.figure()
plt.scatter(st_t_list,st_A_expc,label='Suzuki Trotter A',marker ='^')
plt.plot(t50_1000steps14,At_list14,label="Exact A", linestyle = '-')
plt.scatter(st_t_list,st_B_expc,label='Suzuki Trotter B',marker='v')
plt.plot(t50_1000steps14,Bt_list14,label="Exact B", linestyle = '--')
plt.legend()
plt.xlim(0,5)
plt.ylim(-0.2,0.6)
plt.xlabel("time")
plt.ylabel("Expectation value")
plt.title("$L = 14 ,\epsilon = 0. 2$")
plt.show()

#--------------------------- Entanglement entropy  vs sub system size-----------------------------

ent_entropy_sub_size_E0_Eptminus2_L8 = np.transpose(np.loadtxt("ent_entropy_sub_size_E0_Eptminus2_L8.txt",dtype=np.complex128))
ent_entropy_sub_size_E0_Eptminus2_L10 = np.transpose(np.loadtxt("ent_entropy_sub_size_E0_Eptminus2_L10.txt",dtype=np.complex128))
ent_entropy_sub_size_E0_Eptminus2_L12 = np.transpose(np.loadtxt("ent_entropy_sub_size_E0_Eptminus2_L12.txt",dtype=np.complex128))
ent_entropy_sub_size_E0_Eptminus2_L14 = np.transpose(np.loadtxt("ent_entropy_sub_size_E0_Eptminus2_L14.txt",dtype=np.complex128))

sub_size8 = ent_entropy_sub_size_E0_Eptminus2_L8[0] 
sub_size10 = ent_entropy_sub_size_E0_Eptminus2_L10[0] 
sub_size12 = ent_entropy_sub_size_E0_Eptminus2_L12[0] 
sub_size14 = ent_entropy_sub_size_E0_Eptminus2_L14[0] 

S_E0_L8 =  ent_entropy_sub_size_E0_Eptminus2_L8[1] 
S_E0_L10 = ent_entropy_sub_size_E0_Eptminus2_L10[1] 
S_E0_L12 =  ent_entropy_sub_size_E0_Eptminus2_L12[1] 
S_E0_L14 =  ent_entropy_sub_size_E0_Eptminus2_L14[1] 

S_E0_minus_pt_two_L8 = ent_entropy_sub_size_E0_Eptminus2_L8[2] 
S_E0_minus_pt_two_L10 =  ent_entropy_sub_size_E0_Eptminus2_L10[2] 
S_E0_minus_pt_two_L12  = ent_entropy_sub_size_E0_Eptminus2_L12[2] 
S_E0_minus_pt_two_L14 = ent_entropy_sub_size_E0_Eptminus2_L14[2] 


plt.figure()
plt.scatter(sub_size8 , S_E0_L8,label="$L = 8$",marker = 'o')
plt.scatter(sub_size10 , S_E0_L10,label="$L = 10$",marker = '.')
plt.scatter(sub_size12 , S_E0_L12,label="$L = 12$",marker = ',')
plt.scatter(sub_size14 , S_E0_L14,label="$L = 14$",marker = 'v')
plt.xlabel("Sub system size")
plt.ylabel("Entanglement entropy (for E nearest to 0)")
plt.legend()
plt.show()

plt.figure()
plt.scatter(sub_size8 , S_E0_minus_pt_two_L8,label="$L = 8$",marker = 'o')
plt.scatter(sub_size10 , S_E0_minus_pt_two_L10,label="$L = 10$",marker = '.')
plt.scatter(sub_size12 , S_E0_minus_pt_two_L12,label="$L = 12$",marker = ',')
plt.scatter(sub_size14 , S_E0_minus_pt_two_L14,label="$L = 14$",marker = 'v')
plt.xlabel("Sub system size")
plt.ylabel("Entanglement entropy (for E nearest to -0.2)")
plt.legend()
plt.show()

#------------- static entanglement entropy and Time evolution of Entanglement entropy-------------------------------


data_EbyL_ent16 = np.loadtxt("data_E_by_L_of_MSS_Ent_entropy_L16")
...
ent_static_16 = data_EbyL16 [1]

n = 25
colors = plt.cm.Blues(np.linspace(0,1,n))
ax1=plt.subplot()
xy = np.vstack([E16,ent_static_16])
z=gaussian_kde(xy)(xy)
fig,ax=plt.subplots()
ax.scatter(E16,ent_static_16 ,c=z,s=10,cmap=plt.cm.jet,label="L = 16")
plt.xlabel("E/L",fontsize =10)
plt.ylabel("static_entanglement_entropy")
...
ent_entropy_time_evolution_L14 = np.loadtxt("ent_entropy_time_evolution_L14.txt")

ent14_0 = ent_entropy_time_evolution_L14[0]
ent14_1 = ent_entropy_time_evolution_L14[1]
ent14_2 = ent_entropy_time_evolution_L14[2]
ent14_3 = ent_entropy_time_evolution_L14[3]
ent14_4 = ent_entropy_time_evolution_L14[4]
ent14_5 = ent_entropy_time_evolution_L14[5]

sub_sys = np.arange(0,15,1)

plt.figure()
plt.scatter(sub_sys,ent14_0, marker = 'o',label ="$ t = 0.0 $")
plt.scatter(sub_sys,ent14_1, marker = ',',label ="$ t = 1.0 $")
plt.scatter(sub_sys,ent14_2, marker = 's',label ="$ t = 2.0 $")
plt.scatter(sub_sys,ent14_3, marker = 'v',label ="$ t = 3.0 $")
plt.scatter(sub_sys,ent14_4, marker = '.',label ="$ t = 4.0 $")
plt.scatter(sub_sys,ent14_5, marker = '^',label ="$ t = 5.0 $")
plt.legend()
plt.xlabel("Sub system size")
plt.ylabel("Entanglement entropy")
plt.show()
